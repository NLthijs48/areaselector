...
public class PreferencesPanel extends JPanel {
	...
	private void initialize() {
		...
		this.addInput(
			...
			tr("Preset name"),
			txtPresetName,
			tr("The name of the preset dialog to use, like \"Geography/Land use/Grass\"."),
			true
		);
	...
	public void savePreferences() {
		...
		new StringProperty(AreaSelectorAction.KEY_TAGGINGPRESETNAME, "").put(txtPresetName.getText());
	}
	...
	public void readPreferences() {
		...
		txtPresetName.setText(new StringProperty(AreaSelectorAction.KEY_TAGGINGPRESETNAME, "").get());
